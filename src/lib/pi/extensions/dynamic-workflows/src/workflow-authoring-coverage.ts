...
import { WORKFLOW_CAPABILITY_DEFINITION } from "./workflow-capability-contract.ts";
import { COMPREHENSION_SCENARIOS } from "./workflow-comprehension.ts";
...
export const WORKFLOW_AUTHORING_FROZEN_FILES = [
  ...
  },
  {
    ...
    sha256: "3995e2374cc042ec2a9507b683f7550c8bd5750ccbccbb3eb9c28cae8ac6ec09",
  },
  {
