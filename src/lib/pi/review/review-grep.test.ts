...
describe("parseGrepOutput", () => {
  it("reads path, line and text from the NUL-separated form", () => {
    const output =
      "src/lib/pi/review/review-service.ts\x0025\x00  readTurnMark,\n" +
      "src/lib/pi/review/review-service.ts\x00110\x00  const mark = readTurnMark(id);\n";

    expect(parseGrepOutput(output)).toEqual([
      { line: 25, path: "src/lib/pi/review/review-service.ts", text: "readTurnMark," },
      {
        line: 110,
        path: "src/lib/pi/review/review-service.ts",
