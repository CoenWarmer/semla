...
export class WorkflowManager extends EventEmitter {
    ...
    startInBackground(script, args, exec = {}) {
        ...
        // Register in the shared globalThis registry so Semla's snapshot API can
        // access live running agent state across jiti module boundaries.
        const _semlaKey = Symbol.for("semla.workflow.managers");
        const _semlaReg = (globalThis[_semlaKey] ??= new Map());
